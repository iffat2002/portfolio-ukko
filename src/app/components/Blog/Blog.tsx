...
const Blog = () => {
  return (
    <section className="elementor-section elementor-top-section elementor-element elementor-element-70c2f970 op-section full-width elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="70c2f970" data-element_type="section" id="blog">
       <div className="elementor-container elementor-column-gap-no">
          <div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-2acffe1b" data-id="2acffe1b" data-element_type="column">
             <div className="elementor-widget-wrap elementor-element-populated">
                ...
                <div className="elementor-element elementor-element-7c29fe38 elementor-widget__width-initial elementor-widget elementor-widget-text-editor" data-id="7c29fe38" data-element_type="widget" data-widget_type="text-editor.default">
                   <div className="elementor-widget-container"> Viverra tristique placerat massa est consectetur quisque nu fames lorem</div>
                </div>
                <div className="elementor-element elementor-element-14c2b970 elementor-widget elementor-widget-coco-blog" data-id="14c2b970" data-element_type="widget" data-widget_type="coco-blog.default">
                   <div className="elementor-widget-container">
                            ...
                            <div className="blog-list-info">
                               ...
                               <div className="cat-links-wrapper">
                                  <ul className="cat-links global-color">
                                     <li><a className="global-color" href="">Uncategorized</a></li>
                                  </ul>
                               </div>
                            </div>
                         </li>
                ...
                <div className="elementor-element elementor-element-867a4a4 elementor-widget elementor-widget-coco-button" data-id="867a4a4" data-element_type="widget" data-widget_type="coco-button.default">
                   <div className="elementor-widget-container"> <a className="service-link slow-scroll" href="">READ MORE</a></div>
                </div>
             </div>
          </div>
       </div>
